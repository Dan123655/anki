...
const Slide = observer(({ name, description, id }: myCard, key: number,) => {
    ...
    return (
      ...
      <TouchableOpacity onPress={() =>  setTapped(!tapped) }
       ...
       <View className='bg-yellow-800 w-[90%] mt-10 rounded-[50px] shadow-sm flex-1 items-center justify-center'>
        <View className='flex-row w-[90%] items-center text-center justify-center'>
                 { !tapped&&<Text className='font-semibold text-[32px] text-[#FFFFFF] text-center'>{
