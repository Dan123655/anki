...
class manageCards {
  ...
  myCards: myCard[] =
    [{ "hidden":false,"category":"math","color": "bg-slate-800", "text": "white", "description": "Cepitol of greit Briton7", "id": "d8b975bd-0002-43a8-b98f-e78e08bf4b6b", "name": "Lundun" },
    { "hidden":false,"category":"math","color": "bg-lime-500", "text": "white", "description": "A free and open source programming language by Microsoft. A superset of JavaScript, adds optional static typing to the language.", "id": "0d369017-c8ff-4a30-933c-8a22e13c4c52", "name": "Typescript" },
    { "hidden":false,"category":"math","color": "bg-orange-500", "text": "white", "description": "She's so fat, I swerved to miss her in my car and ran out of gas.", "id": "c8c593d8-71b4-47b3-9cce-8a8b09f4430e", "name": "Yo mama" }]
  constructor() {
  ...
  hideCard(id: string | number[]) {
  //change card.hidden to true
